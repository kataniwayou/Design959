...
public class BaseMcpServer : IMcpServer
{
    ...
    public async Task<McpResponse> ProcessRequestAsync(McpRequest request, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var result = request.Method switch
            {
                ...
                "logging/setLevel" => await HandleSetLoggingLevelAsync(request, cancellationToken),
    ...
    public McpServerCapabilities GetCapabilities()
    {
        ...
        {
            Experimental = new Dictionary<string, object>(), // Empty experimental capabilities
    ...
    private Task<object> HandleInitializeAsync(McpRequest request, CancellationToken cancellationToken)
    {
        ...
        var result = new
        {
            protocolVersion = "2024-11-05", // Use the version the client requested or our supported version
    ...
    private Task<object> HandleSetLoggingLevelAsync(McpRequest request, CancellationToken cancellationToken)
    {
        _logger.LogInformation("Handling logging/setLevel request");

        // For now, just acknowledge the request
        // In a full implementation, you would actually change the logging level
